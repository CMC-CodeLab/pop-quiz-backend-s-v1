...
import { ICourseGateway } from "./all-available-courses.gateway";
import { AllAvailableCoursesRequest } from "./all-available-courses.request";
import { AllAvailableCoursesResponse } from "./all-available-courses.response";
